...
- `clientbot/` – клиентский бот для бронирования слотов и управления профилем.
...
- Уведомления администраторов: при бронировании через `clientbot` автоматически отправляются уведомления всем администраторам с информацией о клиенте, дате/времени, типе занятия (самокрутка или с инструктором), станке и велосипеде.
